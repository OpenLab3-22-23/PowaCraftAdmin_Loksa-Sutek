  ...
  return !session ? (
    <div className="w-full h-screen flex justify-center bg-fixed pb-3 bg-cover" style={{ backgroundImage: `url(${backgroundImage})` }}>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col items-center">
        <img className="xl:rounded-full xl:border-4 xl:border-amber-400 invisible xl:visible absolute xl:relative bg-contain bg-no-repeat mt-9 min-h-44 min-w-44" style={{ backgroundImage: `url(${logo})` }}></img>
