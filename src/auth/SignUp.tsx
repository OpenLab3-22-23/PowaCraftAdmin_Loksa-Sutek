  ...
  return !session ? (
    <div className="w-full h-max lg:h-screen flex justify-center bg-fixed bg-no-repeat pb-3" style={{ backgroundImage: `url(${backgroundImage})` }}>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col items-center">
        <img className="xl:rounded-full xl:border-4 xl:border-amber-400 invisible xl:visible absolute xl:relative bg-contain bg-no-repeat mt-9 min-h-52 min-w-52" style={{ backgroundImage: `url(${logo})` }}></img>
