...
export default function LogIn() {
  ...
  return !session? (
    <div id="login" className="w-full h-screen flex flex-col justify-center bg-fixed bg-no-repeat bg-cover bg-center" style={{ backgroundImage: `url(${backgroundImage})` }}>
      ...
      <form onSubmit={handleLogIn} className=" slidefromtop flex flex-col items-center gap-5">
        <div className="flex flex-col justify-center items-center">
          <img className="shadow xl:rounded-full xl:border-4 xl:border-amber-400 invisible xl:visible absolute xl:relative bg-contain bg-no-repeat h-56 w-56" style={{ backgroundImage: `url(${logo})` }}></img>
          <h2 className="shadowT text-5xl lg:text-7xl text-white text-center lg:mt-0 mt-32">{t("login.header")}</h2>
          <h3 className="shadowT text-3xl lg:text-5xl text-amber-400">{t("login.subheader")}</h3>        
        </div>
        <div className="flex flex-col justify-center items-center gap-5">
          <div className="flex flex-col justify-center items-center">
            ...
            <input
              ...
              className="shadow w-80 lg:w-96 bg-gray-200 rounded-full"
            />            
          </div>
          <div className="flex flex-col justify-center items-center">
